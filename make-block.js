...
function writeStyles(blockName) {
  const stream = fs.createWriteStream('./src/shared/sass/style.sass', {flags: 'a'});
  stream.write(`@import "../../components/${blockName}/${blockName}\"\n`);
}
